...
<head>
    ...
    <title>Quantum E-waste Management System - E-waste we buy</title>
...
<body>
    ...
    <div id="side-navigation-menu" class="sidenav">
        ...
        <a href="#" onclick="closeNav()">E-waste we buy</a>
    ...
    <div id="basket">
        ...
        <div class="page-title-banner-container">
            <div class="page-title-banner-content">E-waste we buy</div>
        </div>
