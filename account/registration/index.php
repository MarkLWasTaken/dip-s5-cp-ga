...
<head>
    ...
    <title>Quantum E-waste Management System - Account Registration</title>
...
<body>
    ...
    <div id="basket">
        ...
        <!-- Layout for the account registration form. -->
            ...
            <div id="registration-content">
                ...
                <form action="process.php" method="post">
                    <table id="registration-form">
                        <tr>
                            <th>First Name:</th>
                            <td><input class="font-size-18" type="text" name="txtFName"></td>
                        </tr>
                        <tr>
                            <th>Last Name:</th>
                            <td><input class="font-size-18" type="text" name="txtLName"></td>
                        </tr>
                        <tr>
                            <th>Email Address*:</th>
                            <td><input class="font-size-18" type="email" name="txtEmail" required></td>
                        </tr>
                        <tr>
                            <th>Password*:</th>
                            <td><input class="font-size-18" type="password" name="txtPassword" required></td>
                        </tr>
                        <tr>
                            <th>Gender:</th>
                            <td>
                                <input class="font-size-18" id="male" type="radio" name="rdoGender" value="Male">
                                <label for="male">Male</label>
                                <div class="margin-20px"></div>
                                <input class="font-size-18" id="female" type="radio" name="rdoGender" value="Female">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select class="font-size-18" name="selCountry" required>
                                    <?php
                                    // Include the PHP script for connecting to the database (DB).
