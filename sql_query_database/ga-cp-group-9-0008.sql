...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2025 at 01:28 PM
...
ALTER TABLE `requests`
  ...
  ADD CONSTRAINT `requests_ibfk_3` FOREIGN KEY (`accounts_payable_id`) REFERENCES `accounts_payable` (`accounts_payable_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `requests_ibfk_4` FOREIGN KEY (`accounts_receivable_id`) REFERENCES `accounts_receivable` (`accounts_receivable_id`) ON DELETE CASCADE ON UPDATE CASCADE;
